...
<script runat="server">
    public void Page_Load()
    {
        ...
        SqlConnection connection = new SqlConnection(ConfigurationManager.ConnectionStrings["proConnStr"].ConnectionString);
        try
        {
            connection.Open();
    ...
    public static DailyEZ.Web.com.dailyez.Link[] GetLinksFromPage(int pageID, SqlConnection conn, HttpResponse response)
    { 
    ...
    private static DailyEZ.Web.com.dailyez.Link[] BuildLink(SqlDataReader reader, HttpResponse response)
    {
        DailyEZ.Web.com.dailyez.Link link = null;
        ...
        try
        {
            if (reader.HasRows)
            {
                while (reader.Read())
                {
                    link = new DailyEZ.Web.com.dailyez.Link();
            ...
            return (DailyEZ.Web.com.dailyez.Link[])list.ToArray(typeof(DailyEZ.Web.com.dailyez.Link));
        }
        catch (Exception ex)
        {
