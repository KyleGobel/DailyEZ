...
<head runat="server">
    ...
    <title></title>
      <% if (HttpContext.Current.IsDebuggingEnabled) { %>
        ...
        <script src="../../javascript/jquery-ui-1.8.20.min.js" type="text/javascript"></script>
    <% }else{ %>
        <script src="http://static.dailyez.com/client/combined.<%=DailyEZVersion %>.min.js" type="text/javascript"></script>
