...
namespace DailyEZ.Web.UnitTests.VM_Tests.DefaultVM
{
    public class RightStack
    {
        ...
        [Test]
        public void return_empty_string_when_right_stack_is_non_existant()
        {
            var dailyEZ = new JetNettApi.Models.DailyEZ { DefaultRightStack = 0 };
        ...
        public void removes_seperators_from_widget_string()
        {
            ...
            var vm = new DefaultViewModel(new JetNettApi.Models.DailyEZ() { DefaultRightStack = 0 }, mock.Object);
            var result = vm.RightStackHtml();
